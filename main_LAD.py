...
def LADSAC_TS_algorithm():
    ...
    denoising_steps = 3  # The denoising steps in the diffusion-based scheduling model
    ...
    # =============== Distributed LADSAC-based Task Scheduling and Network Model Training ===================
